...
import com.himanshu.fragments.databinding.FragmentFirstBinding

//import androidx.fragment.app.FragmentActivity
//import layout.ActivityInterface
...
class FirstFragment : Fragment(), ActivityInterface{
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        tvText?.setOnClickListener{
            Toast.makeText(requireActivity(), "Clicked from Fragment", Toast.LENGTH_SHORT).show()
